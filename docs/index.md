...
*   **Hierarchical Data**: Organize your campaign in a tree structure.
*   **Interactive Shell**: Navigate your data like a file system (`cd`, `ls`).
*   **Context-Aware Commands**: Commands change based on where you are in the tree.
*   **Dice Rolling**: Built-in dice roller (`roll 3d6`).
